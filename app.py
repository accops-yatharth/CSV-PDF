...
def csv_pdf():
    ...
    pdfkit.from_string(html, f'{PATH_TO_PDF}/temp_{current_time}.pdf', options={"quiet": ""})
    return jsonify({"message":"File generated.", "path":f'{PATH_TO_PDF}/temp_{current_time}.pdf'}), 200
